...
def check_answer():
   ...
   if answers[0].isChecked():
      ...
      window.score += 1
      print('Статистика\n-Всего вопросов:', window.total, 'Правильный ответов:', window.score)
      print('Рейтинг:', window.score/window.total, 'Правильных ответов:', window.score)
   else:
...
def next_question():
   ...
   cur_question = randint(0, len(questions_list) - 1) # нам не нужно старое значение,поэтому можно использовать локальную переменную!
